...
\section{\textbf{Online courses}}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Databases and SQL for Data Science with Python}{CGPA: 100\%}
      {Coursera - Verif y at: https://coursera.org/verify/KWDA3ZNARQJF}{2024}
    \resumeSubheading
      {Python Developer}{CGPA: 100\%}
      {Sololearn course}{2023}
  \resumeSubHeadingListEnd
\vspace{-5.5mm}
%
